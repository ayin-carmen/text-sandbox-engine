...
## 2026-07-24 - 补强阶段 10 实体试玩验收

### 修复

- 将阶段 10 端到端测试补强为真实试玩闭环：创建物品、生成场景效果、保存场景并执行按钮对应的场景选项。
- 增加玩家背包状态断言，确认新建物品可以被真实运行时效果使用。

### 验证

- 阶段 10 实体端到端测试通过。

## 2026-07-24 - 完成阶段 10.6 文档与表单测试基础

### 新增

- 新增阶段 10 世界实体编辑器使用说明和完成报告。
- 更新通用使用说明、README 和编辑器版本标记，切换到阶段 10 使用路径。
- 新增角色、地点实体结构化表单的 React 测试，覆盖标签、地点、背包和连接字段回写。
